...
<div class="modal-body">
  ...
  <form class="form-horizontal" action="index.html" method="post">
    ...
    <div class="form-group">
      <label class="col-sm-3 control-label" for="">Nama Diklat</label>
      <div class="col-sm-9">
        <input type="text" class="form-control" disabled value="<?php echo $data->nama_diklat ?>">
      </div>
    </div>
  </form>
